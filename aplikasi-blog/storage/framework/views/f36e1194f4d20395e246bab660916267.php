...
<body>
    ...
    <header class="site-header">
        <div class="container py-3 d-flex flex-wrap align-items-center justify-content-between">
            <a href="<?php echo e(route('pengunjung.index')); ?>" class="text-white">
            ...
            <nav class="d-flex gap-3 mt-2 mt-md-0">
                <a class="nav-link" href="<?php echo e(route('pengunjung.index')); ?>">Beranda</a>
                <a class="nav-link" href="<?php echo e(route('pengunjung.index')); ?>">Artikel</a>
                <a class="nav-link" href="<?php echo e(route('pengunjung.index')); ?>#kategori">Kategori</a>
    ...
    <footer class="site-footer py-3 mt-4">
        <div class="container text-center">
            &copy; <?php echo e(date('Y')); ?> Blog Kami. Seluruh hak cipta dilindungi.
        </div>
    </footer>

</body>
</html>
<?php /**PATH D:\laragon\www\sistem_manajemen_blog\aplikasi-blog\resources\views/layouts/pengunjung.blade.php ENDPATH**/ ?>